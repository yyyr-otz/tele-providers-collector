...
#    print(id_rewrite)
    # 替换加速端口
    port_80 = re.sub(r'(?<=[0-9\]]:)80(?=\?)|(?<=[0-9\]]:)8880(?=\?)|(?<=[0-9\]]:)2052(?=\?)|(?<=[0-9\]]:)2082(?=\?)|(?<=[0-9\]]:)2086(?=\?)|(?<=[0-9\]]:)2095(?=\?)', "8080", vless_former)
    port_443 =  re.sub(r'(?<=[0-9\]]:)443(?=\?)|(?<=[0-9\]]:)2053(?=\?)|(?<=[0-9\]]:)2083(?=\?)|(?<=[0-9\]]:)2087(?=\?)|(?<=[0-9\]]:)2096(?=\?)', "8443", port_80)
#    # 替换优选IP
