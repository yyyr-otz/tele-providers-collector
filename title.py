...
def check_modify_config(array_configuration, protocol_type, check_connection = True):
    ...
    if protocol_type == 'VLESS' or protocol_type == 'REALITY':
...
def create_country_table(country_path):
    ...
    country_url_pattern = '[Subscription Link](https://raw.githubusercontent.com/soroushmirzaei/telegram-configs-collector/vless-tuic-hy2/countries/{country_code}/mixed)'
