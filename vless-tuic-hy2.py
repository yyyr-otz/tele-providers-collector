...
def find_matches(text_content):
    ...
    return matches_usersname, matches_url, matches_vless, matches_reality, matches_tuic, matches_hysteria, matches_juicity
...
for channel_user, message in channel_messages_array:
    try:
        ...
        _ , _ , matches_vless, matches_reality, matches_tuic, matches_hysteria, matches_juicity = find_matches(config_text_content)
...
for channel_user, messages in channel_check_messages_array:
    ...
    for message in messages:
        try:
            ...
            matches_username, matches_url, _ , _ , _ , _ , _ , _ , _ , _ = find_matches(url_text_content)
            _ , _ , matches_vless, matches_reality, matches_tuic, matches_hysteria, matches_juicity = find_matches(config_text_content)
            total_config = total_config + len(matches_vless) + len(matches_reality) + len(matches_tuic) + len(matches_hysteria) + len(matches_juicity)
...
# url = 'https://raw.githubusercontent.com/yyyr-otz/tele-providers-collector/vless-tuic-hy2/telegram channels.json'
...
accept_chars = ['sub', 'subscribe', 'token', 'workers', 'worker', 'dev', 'txt', 'vless', 'reality']
...
for url_link, content in array_links_content_decoded:
    ...
    content_merged = "\n".join(content)
    match_user, match_url, match_vless, match_reality, match_tuic, match_hysteria, match_juicity = find_matches(content_merged)

    if len(match_vless) + len(match_reality) + len(match_tuic) + len(match_hysteria) + len(match_juicity) != 0:
...
for url_link, content in raw_array_links_content_decoded:
    # Merge all subscription links content and find all protocols matches base on protocol pattern
    raw_content_merged = "\n".join(content)
    match_user, match_url, match_vless, match_reality, match_tuic, match_hysteria, match_juicity = find_matches(raw_content_merged)
...
def remove_duplicate(vless_array, reality_array, tuic_array, hysteria_array, juicity_array, vmess_decode_dedup = True):
    ...
    return vless_array, reality_array, tuic_array, hysteria_array, juicity_array



def modify_config(vless_array, reality_array, tuic_array, hysteria_array, check_port_connection = True):
    ...
    for array in [vless_tls_array, reality_tls_array]:
        tls_array.extend(array)
    for array in [vless_non_tls_array, reality_non_tls_array]:
        non_tls_array.extend(array)

    for array in [vless_tcp_array, reality_tcp_array]:
        tcp_array.extend(array)
    for array in [vless_ws_array, reality_ws_array]:
        ws_array.extend(array)
    for array in [vless_http_array, reality_http_array]:
        http_array.extend(array)
    for array in [vless_grpc_array, reality_grpc_array]:
        grpc_array.extend(array)

    return vless_array, reality_array, tuic_array, hysteria_array, tls_array, non_tls_array, tcp_array, ws_array, http_array, grpc_array


# Remove Duplicate Configurations
configs_list_array = [array_vless, array_reality, array_tuic, array_hysteria, matches_vless, matches_reality, matches_tuic, matches_hysteria, raw_matches_vless, raw_matches_reality, raw_matches_tuic, raw_matches_hysteria, channel_matches_vless, channel_matches_reality, channel_matches_tuic, channel_matches_hysteria]
...
array_vless, array_reality, array_tuic, array_hysteria, matches_vless, matches_reality, matches_tuic, matches_hysteria, raw_matches_vless, raw_matches_reality, raw_matches_tuic, raw_matches_hysteria, channel_matches_vless, channel_matches_reality, channel_matches_tuic, channel_matches_hysteria = array_removed_duplicate_list_configurations


# Remove duplicate configurations of telegram channels and subscription links contents
array_vless, array_reality, array_tuic, array_hysteria, array_juicity = remove_duplicate(array_vless, array_reality, array_tuic, array_hysteria, array_juicity)
matches_vless, matches_reality, matches_tuic, matches_hysteria, matches_juicity = remove_duplicate(matches_vless, matches_reality, matches_tuic, matches_hysteria, matches_juicity)
raw_matches_vless, raw_matches_reality, raw_matches_tuic, raw_matches_hysteria, raw_matches_juicity = remove_duplicate(raw_matches_vless, raw_matches_reality, raw_matches_tuic, raw_matches_hysteria, raw_matches_juicity)
channel_matches_vless, channel_matches_reality, channel_matches_tuic, channel_matches_hysteria, channel_matches_juicity = remove_duplicate(channel_matches_vless, channel_matches_reality, channel_matches_tuic, channel_matches_hysteria, channel_matches_juicity)

# Checkout connectivity and modify title and protocol type address and resolve IP address
array_vless, array_reality,  array_tuic, array_hysteria, array_tls, array_non_tls, array_tcp, array_ws, array_http, array_grpc = modify_config(array_vless, array_reality, array_tuic, array_hysteria)
matches_vless, matches_reality, matches_tuic, matches_hysteria, matches_tls, matches_non_tls, matches_tcp, matches_ws, matches_http, matches_grpc = modify_config(matches_vless, matches_reality, matches_tuic, matches_hysteria)
raw_matches_vless, raw_matches_reality, raw_matches_tuic, raw_matches_hysteria, raw_matches_tls, raw_matches_non_tls, raw_matches_tcp, raw_matches_ws, raw_matches_http, raw_matches_grpc = modify_config(raw_matches_vless, raw_matches_reality, raw_matches_tuic, raw_matches_hysteria, check_port_connection = False)
channel_matches_vless, channel_matches_reality, channel_matches_tuic, channel_matches_hysteria, channel_matches_tls, channel_matches_non_tls, channel_matches_tcp, channel_matches_ws, channel_matches_http, channel_matches_grpc = modify_config(channel_matches_vless, channel_matches_reality, channel_matches_tuic, channel_matches_hysteria, check_port_connection = True)
...
array_vless_channels, array_reality_channels, array_tuic_channels, array_hysteria_channels, array_juicity_channels = remove_duplicate(array_vless_channels, array_reality_channels, array_tuic_channels, array_hysteria_channels, array_juicity_channels)
channel_matches_vless, channel_matches_reality, channel_matches_tuic, channel_matches_hysteria, channel_matches_juicity = remove_duplicate(channel_matches_vless, channel_matches_reality, channel_matches_tuic, channel_matches_hysteria, channel_matches_juicity)
...
# Remove Duplicate Configurations
array_list_configurations = [array_vless, array_reality, array_tuic, array_hysteria, matches_vless, matches_reality, matches_tuic, matches_hysteria, raw_matches_vless, raw_matches_reality, raw_matches_tuic, raw_matches_hysteria, channel_matches_vless, channel_matches_reality, channel_matches_tuic, channel_matches_hysteria]
array_removed_duplicate_list_configurations = list()
...
array_mixed = array_vless + array_reality + array_tuic + array_hysteria
...
def create_title(title, port):
    ...
    return reality_config_title, vless_config_title
...
reality_update, vless_update = create_title(datetime_update_str, port = 1080)
...
reality_dev_sign, vless_dev_sign = create_title(dev_sign, port = 8080)
...
all_subscription_matches = matches_vless + matches_reality
...
# Decode vmess configs to change title and remove duplicate
all_channel_matches = array_vless_channels + array_reality_channels
